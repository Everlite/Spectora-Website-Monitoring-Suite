...
- UI follows a Google-Analytics-like report: light canvas, left nav, white cards, Roboto, blue `#1a73e8`. Score is labeled Dokument-Score — HTML Spectora fetched, not Lighthouse.
