<div x-show="isDeleteModalOpen" 
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-show="isDeleteModalOpen" 
             ...
             class="inline-block align-bottom bg-[#111622] border border-[#202A3E] rounded-studio text-left overflow-hidden shadow-studio-card transform transition-all sm:my-8 sm:align-middle sm:max-w-md w-full">
            
            <div class="p-6 space-y-4">
                <div class="flex items-start gap-3">
                    <div class="w-9 h-9 rounded-studio-sm bg-[#F43F5E]/15 border border-[#F43F5E]/30 flex items-center justify-center shrink-0 text-[#F43F5E]">
