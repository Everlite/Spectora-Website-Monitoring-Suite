<div x-show="isDeleteModalOpen" 
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-show="isDeleteModalOpen" 
             ...
             class="inline-block align-bottom bg-studio-surface border border-studio-border rounded-studio text-left overflow-hidden shadow-studio-card transform transition-all sm:my-8 sm:align-middle sm:max-w-md w-full">
            
            <div class="p-6 space-y-4">
                <div class="flex items-start gap-3">
                    <div class="w-9 h-9 rounded-studio-sm bg-studio-rose/15 border border-studio-rose/30 flex items-center justify-center shrink-0 text-studio-rose">
                ...
                <div class="flex items-center justify-end gap-2.5 pt-3 border-t border-studio-border mt-4">
                    <button type="button" @click="closeDeleteModal()" class="btn-spectora-secondary">
                        Abbrechen
                    </button>
                    <button type="button" @click="submitDelete()" class="btn-spectora-danger">
                        Endgültig löschen
                    </button>
                </div>
            </div>
