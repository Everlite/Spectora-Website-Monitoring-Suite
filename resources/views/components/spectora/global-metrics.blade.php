...
<div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
    ...
    <div class="spectora-card p-4.5">
        <div class="flex items-center justify-between pb-1.5">
            <span class="text-[11px] font-bold uppercase tracking-wider text-studio-muted">Flotten-Ziele</span>
            <div class="w-7 h-7 rounded-studio-sm bg-studio-elevated border border-studio-border flex items-center justify-center text-studio-brand">
        ...
        <div>
            ...
            <p class="text-[11px] text-studio-muted mt-1 flex items-center gap-1.5 font-medium">
                <span class="text-studio-emerald font-bold">{{ $kpis['online_count'] ?? 0 }} Online</span>
    ...
    <div class="spectora-card p-4.5">
        <div class="flex items-center justify-between pb-1.5">
            <span class="text-[11px] font-bold uppercase tracking-wider text-studio-muted">30-Tage SLA Uptime</span>
            <div class="w-7 h-7 rounded-studio-sm bg-studio-elevated border border-studio-border flex items-center justify-center text-studio-emerald">
        ...
        <div>
            <div class="text-2xl font-bold font-mono tracking-tight {{ ($kpis['global_uptime'] ?? 100) >= 99 ? 'text-studio-emerald' : 'text-studio-amber' }}">
    ...
    <div class="spectora-card p-4.5">
        <div class="flex items-center justify-between pb-1.5">
            <span class="text-[11px] font-bold uppercase tracking-wider text-studio-muted">Aktive Störungen</span>
            <div class="w-7 h-7 rounded-studio-sm bg-studio-elevated border border-studio-border flex items-center justify-center {{ ($kpis['active_incidents'] ?? 0) > 0 ? 'text-studio-rose' : 'text-studio-muted' }}">
        ...
        <div>
            <div class="text-2xl font-bold font-mono tracking-tight {{ ($kpis['active_incidents'] ?? 0) > 0 ? 'text-studio-rose' : 'text-white' }}">
    ...
    <div class="spectora-card p-4.5">
        <div class="flex items-center justify-between pb-1.5">
            <span class="text-[11px] font-bold uppercase tracking-wider text-studio-muted">Pulse Telemetrie (24h)</span>
            <div class="w-7 h-7 rounded-studio-sm bg-studio-elevated border border-studio-border flex items-center justify-center text-studio-sky">
