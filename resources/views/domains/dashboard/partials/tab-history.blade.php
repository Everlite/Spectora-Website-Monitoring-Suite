                ...
                <div class="spectora-card p-5">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-2.5">
                            <div class="w-8 h-8 rounded-studio-sm bg-studio-elevated border border-studio-border flex items-center justify-center text-studio-brand">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] text-studio-muted">Letzter automatischer Sicherheits- und Performance-Scan</p>
                            </div>
                        </div>

                        <div class="flex items-center gap-2">
                            <span class="px-2.5 py-0.5 rounded text-xs font-bold font-mono {{ ($criticalCount ?? 0) === 0 ? 'bg-studio-emerald/15 text-studio-emerald border border-studio-emerald/30' : 'bg-studio-rose/15 text-studio-rose border border-studio-rose/30' }}">
                                {{ ($criticalCount ?? 0) === 0 ? '0 Kritische Fehler' : $criticalCount.' Kritisch' }}
                            </span>
                            @if(($warningCount ?? 0) > 0)
                                <span class="px-2.5 py-0.5 rounded text-xs font-bold font-mono bg-studio-amber/15 text-studio-amber border border-studio-amber/30">
