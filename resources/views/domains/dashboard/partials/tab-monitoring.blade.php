                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        ...
                        <div class="spectora-card p-5">
                            <h3 class="text-xs font-bold uppercase tracking-wider text-studio-text mb-3 flex items-center gap-2">
                            ...
                            <div class="space-y-2.5">
                                ...
                                <label class="flex items-center justify-between p-3 rounded-studio-sm border border-studio-border bg-studio-bg hover:bg-studio-elevated/50 transition-colors cursor-pointer">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-bold text-xs text-studio-text">Nur öffentliche Seiten</p>
                                ...
                                <label class="flex items-center justify-between p-3 rounded-studio-sm border border-studio-border bg-studio-bg hover:bg-studio-elevated/50 transition-colors cursor-pointer">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-bold text-xs text-studio-text">Robots.txt beachten</p>
                                ...
                                <label class="flex items-center justify-between p-3 rounded-studio-sm border border-studio-border bg-studio-bg hover:bg-studio-elevated/50 transition-colors cursor-pointer">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-bold text-xs text-studio-text">Noindex respektieren</p>
                    ...
                    <div class="space-y-4">
                        <div class="spectora-card p-5">
                            <h3 class="text-xs font-bold uppercase tracking-wider text-studio-text mb-2">Unterseiten-Wächter</h3>
                            ...
                            <div class="p-3 bg-studio-bg border border-studio-border rounded-studio-sm">
                                ...
                                <div class="text-xl font-bold font-mono text-studio-text mt-0.5">
