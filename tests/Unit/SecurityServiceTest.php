...
class SecurityServiceTest extends TestCase
{
    ...
    {
        $this->assertFalse(SecurityService::resolve()->isSafeIp('127.0.0.1'));
        $this->assertFalse(SecurityService::resolve()->isSafeUrl('http://127.0.0.1/'));
    }

    public function test_rejects_private_ranges(): void
    {
        $this->assertFalse(SecurityService::resolve()->isSafeIp('10.0.0.1'));
        $this->assertFalse(SecurityService::resolve()->isSafeIp('192.168.0.1'));
        $this->assertFalse(SecurityService::resolve()->isSafeUrl('http://10.0.0.1/'));
    }

    public function test_accepts_public_ip_literal(): void
    {
        $this->assertTrue(SecurityService::resolve()->isSafeIp('8.8.8.8'));
        $this->assertTrue(SecurityService::resolve()->isSafeUrl('https://8.8.8.8/'));
    }

    public function test_rejects_localhost_hostname(): void
    {
        $this->assertFalse(SecurityService::resolve()->isSafeUrl('http://localhost/'));
    }

    public function test_resolve_pins_for_public_ip_literal(): void
    {
        $pins = SecurityService::resolve()->resolvePinsForUrl('https://1.1.1.1/');
    ...
    public function test_resolve_pins_throws_for_unsafe_url(): void
    {
        ...
        SecurityService::resolve()->resolvePinsForUrl('http://127.0.0.1/');
    }

    public function test_resolve_pins_uses_single_dns_resolution_for_public_ip_literal(): void
    {
        $pinsA = SecurityService::resolve()->resolvePinsForUrl('https://1.1.1.1/');
        $pinsB = SecurityService::resolve()->resolvePinsForUrl('https://1.1.1.1/');
    ...
    {
        $middleware = SecurityService::resolve()->buildRedirectMiddleware();
        $onRedirect = null;
